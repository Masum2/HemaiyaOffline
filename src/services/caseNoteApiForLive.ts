...
const API_BASE_URL = 'https://jsonplaceholder.typicode.com/api/OfflineSync';
// Real URL: https://your-actual-server.com/api/OfflineSync

// 🎭 Mock Mode - true হলে রিয়েল API কল না করে Mock ডেটা দেখাবে
const USE_MOCK_MODE = true; // true = Mock Mode, false = Real API
...
const buildPeopleData = (noteData: any): string | null => {
  try {
    ...
    // Build from parentNames and childNames
    const peopleData = {
